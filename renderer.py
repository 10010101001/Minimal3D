...
for u in range(-180,1):
  for v in range(-180,180):
    t=(v/float(180))*0.785+Angle;x=int(sin(t)*-u+locX);y=int(cos(t)*-u+locY) ;h=disp[x,y];height=(h-float(disp[locX,locY] )/-u*100 + 120);pygame.draw.line(screen, rgb_im.getpixel((x,y)), (180+v,0),(180+v,202-height),1);pygame.display.flip()
